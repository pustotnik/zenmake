...
Here some tips which can help to improve performance of ZenMake in some cases
...
difference in performance of ZenMake. It's recommended to check if it really has
positive effect before using of md5.
